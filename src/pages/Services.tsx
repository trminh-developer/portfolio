        ...
        <div className="page-container">
          <div className="section-header fade-up">
            <span className="page-tag">
              <i className="bi bi-gear-fill"></i> &nbsp;DỊCH VỤ
            </span>
            <h1>SERVICES</h1>
            <p>
              Các dịch vụ IT và phần mềm tôi cung cấp.
            </p>
            ...
            <div className="project-card fade-up">
              ...
              <div className="project-body">
                ...
                <p className="project-desc">
                  Nhận cài đặt Microsoft 365 Office (No Copyright). Hỗ trợ kích hoạt và thiết lập bộ ứng dụng văn phòng đầy đủ tính năng.
                </p>
